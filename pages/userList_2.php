            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="addMovie.php">Zaległości</a></li>
                        <li class="nav-item"><a class="nav-link" href="movieList.php">Filmy</a></li>
                        <li class="nav-item"><a class="nav-link" href="addMovie.php">Dodaj Film</a></li>
                        <li class="nav-item"><a class="nav-link" href="addMovie.php">Usuń Film</a></li>
                        <li class="nav-item"><a class="nav-link" href="addMovie.php">Edytuj Film</a></li>
                    </ul>
                </div>
            </div>
        </nav>
