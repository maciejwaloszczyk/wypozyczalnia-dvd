            ...
            <div class="container px-4 py-4 px-lg-10 d-flex align-content-md-center">
                <form action="../php/userLogin.php" method="POST">
                    <div class="mb-3">
                        ...
                        <div id="emailHelp" class="form-text">Podaj e-mail z którego korzystasz.Prześlemy na niego dalsze instrukcje.
</div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-theme">Dalej</button>
                </form>
            </div>
        </div>
        <!-- Footer-->
